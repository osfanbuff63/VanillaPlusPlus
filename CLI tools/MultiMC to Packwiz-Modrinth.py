...
if refresh_only == False:
    cf_zip_path = input("Please drag the Modrinth .mrpack from MultiMC here: ")[3:][:-1] # Because dragging the file adds "& " and double quotes
    ...
    # Packwiz import
    os.system(packwiz_exe_path + " modrinth import \"" + cf_zip_path + "\"")
    if hydrogen:
