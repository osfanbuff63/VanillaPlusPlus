...
A modpack desiring to improve the vanilla experience, based on Fabulously Optimized.

Currently doesn't work, still in progress.
<details>
  <summary>Original README (Fabulously Optimized)</summary>
